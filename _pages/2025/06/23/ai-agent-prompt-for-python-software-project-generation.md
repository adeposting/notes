...
The full prompt at time of writing is included in the appendix of this article, however the prompt will be optimized over time, so see [github.com/adeposting/prompts/blob/main/src/software-project-generation/python.txt](https://github.com/adeposting/prompts/blob/main/src/software-project-generation/python.txt) for the most recent version.
